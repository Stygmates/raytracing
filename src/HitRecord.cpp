...
HitRecord::HitRecord(Point intersection, bool intersect) : _intersection(intersection), _intersect(intersect)
{
...
bool HitRecord::get_intersect()
{
    return _intersect;
}

void HitRecord::set_intersect(bool intersect)
{
